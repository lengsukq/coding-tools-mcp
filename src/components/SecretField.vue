...
const props = withDefaults(defineProps<{ value: string; busy?: boolean; allowRegenerate?: boolean }>(), {
  busy: false,
...
<template>
  <div class="flex items-center gap-2">
    <div class="relative min-w-0 flex-1">
      <input :value="value" readonly :type="visible ? 'text' : 'password'" class="h-10 w-full rounded-xl border border-white/70 bg-white/60 px-3.5 pr-20 font-mono text-xs outline-none dark:border-white/10 dark:bg-white/6" />
